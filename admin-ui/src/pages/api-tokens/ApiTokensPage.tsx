  ...
  return (
    <div>
      ...
      >
        ...
        <Paragraph
          copyable={{
            text: `claude mcp add localization -e MCP_TOKEN=${newTokenResult?.token} -e BACKEND_URL=${import.meta.env.VITE_BACKEND_URL ?? window.location.origin} -- npx -y localization-mcp-server`,
        ...
        >
          {`claude mcp add localization -e MCP_TOKEN=${newTokenResult?.token} -e BACKEND_URL=${import.meta.env.VITE_BACKEND_URL ?? window.location.origin} -- npx -y localization-mcp-server`}
        </Paragraph>
