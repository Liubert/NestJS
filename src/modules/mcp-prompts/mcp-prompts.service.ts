...
> = {
  ...
  assess: {
    ...
    defaultContent: [
      ...
      '→ Sandbox is auto-initialized — you can start writing immediately after fixing config',
      '',
      ...
      '→ If create now: ask for slug confirmation, then call create_project, create_namespace, create_locale (sandbox is auto-initialized)',
      ...
      '  c) Sandbox is auto-initialized — no manual step needed',
